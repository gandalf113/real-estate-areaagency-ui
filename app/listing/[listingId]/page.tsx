    ...
    return <div className={`max-w-6xl mx-auto`}>
        <div className={`grid grid-cols-6 gap-4 mb-4`}>
            ...
            <div className={`col-span-2`}>
                ...
                <div className={`col-span-2 bg-gray-100 rounded-sm h-fit p-4`}>
                ...
                <h3 className={`text-2xl font-bold mb-2`}>Szczegóły ogłoszenia</h3>
                <div className={`grid grid-cols-1 gap-4 mb-8 p-4`}>
                    <div>
