...
export const navigation = [
    ...
    {
        content: 'Services',
        href: 'https://areaagency.pl/en/?currency=PLN#main-slide-3'
    },
    {
        content: 'Real Estate',
        href: '/',
    ...
    {
        content: 'Team',
        href: 'https://areaagency.pl/en/?currency=PLN#main-slide-5'
    },
    {
        content: 'Reviews',
    ...
    return (
        <nav className={`flex px-[71px] items-center pb-8`}>
            ...
            <div className={`lg:flex hidden flex-col items-center gap-y-[14px] mr-7`}>
                <div className={`h-[25px] w-[1px] bg-[#FF0000] invisible`}/>
                <Link href={`https://areaagency.pl/en/?currency=PLN#main-slide-1`}>
                    <svg width="8" height="8" viewBox="0 0 8 8" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`lg:flex hidden xl:gap-x-4`}>
